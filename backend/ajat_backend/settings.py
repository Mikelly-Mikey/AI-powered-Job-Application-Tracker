...
MONGODB_URI = os.environ.get("MONGODB_URI", "mongodb://localhost:27017/ajat_db")
MONGODB_NAME = os.environ.get("MONGODB_NAME", "ajat_db")
...
ROOT_URLCONF = "ajat_backend.urls"
...
# Cache Configuration (optional - disable if Redis not available)
